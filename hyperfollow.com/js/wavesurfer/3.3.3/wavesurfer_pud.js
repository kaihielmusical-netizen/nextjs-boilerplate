...
function (_util$Observer) {
  ...
  _createClass(Drawer, [{
    ...
    value: function createWrapper() {
	  var myNewClass = document.createElement('wave');
	  myNewClass.className = "slapOuterWave";
      this.wrapper = this.container.appendChild(myNewClass);
...
function (_Drawer) {
  ...
  _createClass(MultiCanvas, [{
    ...
    value: function createElements() {
	  var myNewClass = document.createElement('wave');
	  myNewClass.className = "slapInnerWave";
      this.progressWave = this.wrapper.appendChild(this.style(myNewClass, {
        position: 'absolute',
        zIndex: 3,
        left: 0,
        top: 0,
